<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <form method="POST" action="<?php echo getBaseUrl() ?>/user-profile/update.php">
      <?php
      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-6">
            ...
            <input class="form-control" name="fname" type="text" value="<?php echo $row['fname']; ?>" disabled> 
          </div>
          <div class="col-md-6">
            <label for="InputLname"><strong>Last Name</strong></label>
            <input class="form-control" name="lname" type="text" value="<?php echo $row['lname']; ?>" disabled>
          </div>
          <div class="col-md-6">
            <label for="InputMi"><strong>Middle Initial</strong></label>
            <input class="form-control" name="mi" type="text" value="<?php echo $row['mi']; ?>" disabled>                 
          </div>                      
          <div class="col-md-6">
            <label for="InputAddress"><strong>Address</strong></label>
            <input class="form-control" name="address" type="text" value="<?php echo $row['address']; ?>" disabled>
          </div>
          <div class="col-md-6">
            <label for="InputContactNo"><strong>Contact Number</strong></label>
            <input class="form-control" name="contactNo" type="text" value="<?php echo $row['contactNo']; ?>" disabled>
          </div>
          <div class="col-md-6">
